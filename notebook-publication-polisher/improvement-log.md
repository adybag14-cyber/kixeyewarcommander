...
- Confirmed that the real notebook still contained the older literature citation, overconfident reproducibility wording, raw wide HTML tables, an open second GIF panel and several solvent-order contradictions in the saved discussion and post-lab text.
