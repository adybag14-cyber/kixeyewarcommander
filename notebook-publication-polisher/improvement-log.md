...
- Reordered both inline GIF payloads so their first visible frame is informative rather than nearly blank, and mirrored that preview-frame fix in the stored source code so a future rerun preserves it.
