...
- Verified after writing the polished notebook that:
  ...
  - both GIF panels are closed by default;
  - the polished notebook source now includes the stronger headline result, revised conclusion and revised reproducibility notes.
