...
- Re-verified the polished copy after writing it and confirmed that all 8 embedded PNG figures and both inline GIF payloads decode successfully, both GIF panels open closed by default, and the saved notebook still contains 9 HTML dataframe outputs under the new scroll-protection rules.
