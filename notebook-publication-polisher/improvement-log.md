...
- Expanded the abstract so it now states the retained-trace count, explicit solvent ordering and 46.5-fold span.
...
- Reordered the stored post-lab solvent summary so the listed rates now match the accepted ranking.
