...
- Revalidated the polished notebook by confirming that the 2017 citation is gone, the stronger citation is present, the workflow panel is closed by default, publication-table HTML is embedded in the saved outputs, and all embedded PNG/GIF payloads decode cleanly.
