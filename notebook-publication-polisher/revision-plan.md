...
## 2026-05-17 polished deliverable rebuild from attached package

- [x] Reinspect the attached notebook package, rubric guidance and saved progress notes directly.
- [x] Confirm that the attached notebook still lags behind the intended publication-ready state.
...
- [x] Replace the saved raw-dataframe outputs with captioned, overflow-safe publication tables.
...
- [x] Replace the weaker solvent-effects source with the stronger primary-paper citation and align the narrative to that evidence.
