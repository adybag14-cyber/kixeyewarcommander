...
- Completed: do a final source-versus-rendered-output consistency pass so the post-lab timescale example is corrected in both places, not only in the stored markdown output.
