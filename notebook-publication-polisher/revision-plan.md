...
- Confirmed that the attached source notebook still contained publication-blocking contradictions and rebuilt the polished notebook copy from the attached source rather than relying on old notes alone.
...
- Added notebook-level overflow protection plus stored HTML wrappers for wide rendered tables.
