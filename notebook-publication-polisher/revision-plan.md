...
- Completed: strengthen the abstract and the conclusion so the notebook opens and closes on the same quantitative publication result.
...
- Completed: update the source-side table display helper so future reruns keep horizontal-scroll protection instead of reverting to plain wide tables.
