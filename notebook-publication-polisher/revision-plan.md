...
- [x] Correct the inaccurate solvent-order wording in the generated discussion and post-lab answers.
...
- [ ] Run one final browser-style notebook render export in an environment that has `jupyter`/`nbconvert`.
