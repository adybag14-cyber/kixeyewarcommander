...
- Completed: align the publication-status, rubric and improvement memory files with the rebuilt polished notebook so future runs inherit the corrected state.
