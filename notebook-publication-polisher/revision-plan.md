...
- [x] Replace raw dataframe-style outputs with captioned, index-free publication tables in both the notebook source and the saved executed outputs.
...
- [x] Strengthen the validation narrative so the fit-window sensitivity section explains why the adaptive robust workflow is the defensible reporting choice.
