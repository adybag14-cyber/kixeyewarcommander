...
- [x] Revalidate the polished artifact for decodable media, scroll-safe index-free tables, collapsed GIF panels, removed solvent-order contradictions, and obvious figure-layout defects.
