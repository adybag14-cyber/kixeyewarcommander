...
## 2026-05-21 notebook polish pass
...
- Correct references and reproducibility statements that still overstate what the attached local package can do.
...
- [x] Build the polished notebook deliverable at `/workspace/output/P201_201698955_publication_ready_polished.ipynb`.
- [x] Replace plain rendered dataframe outputs with captioned, scroll-safe publication tables.
...
- [x] Collapse the laboratory workflow GIF panel by default in the executed output.
...
- [ ] Perform one final render audit after that rerun to confirm regenerated figures, GIFs and tables still render cleanly.
