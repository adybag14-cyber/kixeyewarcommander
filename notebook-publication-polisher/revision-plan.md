...
- Confirmed that the live notebook source had drifted back to weaker provenance wording, the older 2017 citation and a couple of evidence mismatches, then patched the actual attached notebook rather than only updating status files.
