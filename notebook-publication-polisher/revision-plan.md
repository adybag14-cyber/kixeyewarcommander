...
- Completed: fix the saved-output presentation issues by wrapping all 9 wide HTML table outputs and ensuring the laboratory workflow GIF panel is collapsed by default in both the saved output state and future source reruns.
