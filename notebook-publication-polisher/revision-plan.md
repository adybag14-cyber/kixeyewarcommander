...
- [x] Repair the opener, abstract, generated discussion, post-lab answers, conclusion, reproducibility appendix note, source-side table renderer, saved table outputs, and default-open workflow GIF panel.
- [x] Revalidate the polished artifact for decodable media, scroll-safe index-free tables, collapsed GIF panels, and removed solvent-order contradictions.
