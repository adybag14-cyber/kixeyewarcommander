...
## Current state after 2026-05-19 render and persistence repair pass
...
- [x] Update the notebook source so future runs emit publication-style report tables.
...
- [x] Collapse both inline GIF extras by default and extend the consistency-check presentation to cover GIF media.
