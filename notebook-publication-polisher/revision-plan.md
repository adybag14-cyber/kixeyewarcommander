...
- [x] Correct any narrative statements that drifted away from the saved numerical solvent ordering.
...
- [x] Strengthen the report flow with better section lead-ins and a stronger primary-literature framing of solvent effects.
...
- [ ] Perform one final post-rerun render audit of regenerated tables, figures, GIF panels, and regenerated publication-table HTML.
