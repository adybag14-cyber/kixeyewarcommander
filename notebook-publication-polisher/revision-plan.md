...
- [x] Replace raw dataframe-style outputs with captioned, index-free publication tables in the saved executed outputs and the main source display helpers.
...
- [ ] Verify the updated notebook source by executing it in an environment that includes the plotting stack used by the report.
