...
- [x] Make the notebook polish reproducible from a workspace rebuild script rather than relying on a previously generated notebook copy.
...
- [x] Record that direct HTML export verification is deferred in this container because `nbconvert` is unavailable.
