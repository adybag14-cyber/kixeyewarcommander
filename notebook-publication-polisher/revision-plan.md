...
## Current state after 2026-05-19 regenerated publication pass
...
- [x] Recreate the repair workflow at `/workspace/repair_publication_notebook.py`.
...
- [x] Collapse the second inline extra by default and extend the consistency-check presentation to cover GIF media.
