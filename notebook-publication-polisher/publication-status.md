...
- Strengthened the source and saved narrative around the verified quantitative story: `111 of 225` retained traces, `Acetonitrile > Acetone > THF > Cyclohexane > Toluene`, and a `46.5-fold` fastest-to-slowest span.
...
- Updated the notebook source so the package audit, report-table helper, and consistency-check section now emit publication-styled HTML tables on future reruns.
