...
- Date: 2026-05-31 17:15 BST scheduled pass.
...
- This pass rebuilt the polished notebook from the attached full-output notebook, because the attached notebook is still the unpolished source version rather than the previous polished copy.
...
- Wide cached DataFrame outputs are wrapped in horizontal-scroll containers, and high-risk display styling has been removed from both source cells and cached HTML outputs.

## Latest Visual Audit

- Revised notebook SHA-256: `d5b3489cfddad1a375036244455d55d756049ec88965976d3cb6b10a7427b211`.
...
- Removed high-risk visual styling in source cells and cached outputs: large radii, heavy shadows, fixed 1080 px GIF caps, negative heading letter spacing and hidden overflow.
