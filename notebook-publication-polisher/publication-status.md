...
- Replaced every remaining raw dataframe-style output with styled, captioned, overflow-safe report tables, including the environment/package audit, kinetic summary, QC audit, bootstrap ranking, benchmark tables, validation summary, sensitivity check, and automated consistency checks.
