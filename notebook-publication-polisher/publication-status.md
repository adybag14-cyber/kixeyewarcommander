...
- Section flow is cleaner: short implementation/reporting sections now include explanatory transitions before parsing, fitting, quality control, execution, validation, figure generation, discussion and post-lab answers.
