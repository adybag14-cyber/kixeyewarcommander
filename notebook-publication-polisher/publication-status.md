...
- Container limitation confirmed this run: the notebook can be inspected and patched as JSON here, but this container does not provide the full Jupyter execution/export stack needed for a clean rerun or notebook-to-HTML rendering pass.
