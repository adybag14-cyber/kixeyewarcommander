...
- Narrative consistency summary: the opening title card, abstract, results discussion, post-lab answers, and conclusion now agree on the same supported ranking and no longer contain the earlier acetone-fastest drift.
...
- Strengthened the conclusion so the notebook closes with the same quantitative result shown earlier in the analysis.
