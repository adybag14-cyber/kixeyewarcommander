...
- Publication-readiness estimate: strong near-publication-ready executed notebook artifact with cleaner display behaviour, stronger internal consistency and more honest reproducibility framing.
- Confidence note: the notebook now reads more like a professional publication artifact, but final sign-off still depends on restoring the missing solvent folders and rerunning the analysis from a complete raw-data bundle.
...
- Replaced the weaker 2017 secondary citation with the stronger 1983 *Journal of Organic Chemistry* paper by Schanze, Mattox and Whitten, DOI `10.1021/jo00165a005`.
