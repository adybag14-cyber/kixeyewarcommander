...
- Confidence note: the polished notebook copy was checked directly after repair, the source now passes a syntax compilation check, all key saved HTML tables were wrapped in scroll-safe captioned figures, both inline GIF outputs decode cleanly and the second GIF panel is closed by default.
