...
- Export-risk styling has been reduced in both source and cached HTML outputs: no negative heading letter spacing, no 18 px wrappers, no heavy 18 px/12 px media-shadow strings, no 1080 px GIF display widths, and table/output overflow guards are present.
