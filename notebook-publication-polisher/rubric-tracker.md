...
- Citation audit found no stale `using RDKit (6)`, `whole workflow (7)` or `formula C16H15N3O2 (6)` text after adding the new review citation and renumbering downstream references.
