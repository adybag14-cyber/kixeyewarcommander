...
- Markdown/LaTeX/HTML/formatting: very strong in the rebuilt polished notebook. It now combines structured markdown, LaTeX, inline HTML media, captioned report tables, clearer provenance notes, collapsed-by-default expandable extras, and cleaner consistency-check presentation without the earlier raw dataframe blocks, inherited index-column clutter, or leftover default dataframe styling; the package-audit, benchmark, validation, sensitivity, and consistency-check source cells now also preserve those captions on future reruns.
