...
- Main uncertainty: the polished notebook now presents the archived execution more professionally, more honestly and with cleaner saved rendering, but the attached local review package still lacks the full five-solvent raw-data tree, so portability and verified rerunnability cannot yet be scored with full confidence.
