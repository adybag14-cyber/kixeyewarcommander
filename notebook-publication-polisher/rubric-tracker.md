...
- Main uncertainty: the notebook now presents the executed artifact more professionally and more honestly, but the attached local review package still lacks the full five-solvent raw-data tree, so portability and verified rerunnability cannot yet be scored with full confidence.
