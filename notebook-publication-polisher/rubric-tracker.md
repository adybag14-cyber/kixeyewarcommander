...
- Markdown, LaTeX, HTML and formatting: outstanding. The notebook uses advanced formatting coherently, avoids nonzero CSS letter spacing in notebook-controlled styles, keeps both large extra GIF panels closed by default, uses cleaner rounded corners, and avoids the known truncated-validation-detail problem in the source.
