...
- Markdown, LaTeX, HTML and formatting: very strong. The notebook now combines polished markdown, inline HTML, captioned tables, collapsible extras and consistent figure styling without the earlier raw-dataframe appearance.
