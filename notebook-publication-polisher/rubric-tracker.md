...
- Markdown/LaTeX/HTML/formatting: very strong. The notebook now uses structured markdown, LaTeX, inline HTML figure panels, captioned scroll-safe report tables and cleaner first-view rendering without any default-open oversized GIF panel.
