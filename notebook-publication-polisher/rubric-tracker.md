...
- Markdown, LaTeX, HTML and formatting: outstanding. The notebook uses advanced formatting coherently, keeps both large extra GIF panels closed by default, avoids tight heading letter spacing and nonzero CSS letter spacing in notebook-controlled styles, and avoids the known truncated-validation-detail problem in the source.
