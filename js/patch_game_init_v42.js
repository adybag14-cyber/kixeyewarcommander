 ...
 * PATCH GAME INIT V42
 * - V41 Logic
 * - NEW: Top-Level Debug Sprite (Green Box)
 */

(function () {
    console.log("[PATCH] V42 Script Loaded");
    ...
    setInterval(function () {
        ...
        // --- DEBUG SPRITE ---
        if (stage && !debugSprite) {
            try {
                var SpriteClass = window.openfl.display.Sprite;
                debugSprite = new SpriteClass();
                ...
                console.log("[PATCH V42] Debug Sprite Added");
            } catch (e) { console.error("Debug Sprite Failed", e); }
        } else if (stage && debugSprite) {
            // Keep on top
            try { stage.setChildIndex(debugSprite, stage.get_numChildren() - 1); } catch (e) { }
        }
